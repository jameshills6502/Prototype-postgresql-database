...
drop trigger if exists loan_move on loans cascade;
...
CREATE TABLE "credit_account" (
  "Account_ID" Integer generated by identity,
  "Customer_ID" Integer,
  "Date_Created" timestamp without time zone,
  "Credit_ Amount" Money,
...
CREATE TABLE "debit_account" (
  "Account_ID" Int identity(1,1), CharID as 'D' + RIGHT('000' + CAST("Account_ID" as Varchar(3)), 3) persisted,
  "Customer_ID" Integer,
  "Date_Created" timestamp without time zone,
  "Balance" Money,
  "Overdraft" Money,
...
create or replace procedure account_application(username varchar(255), requested_account_type varchar(255))
language plpgsql
as
$$
declare
...
create or replace procedure loan_acceptance(Loan_Amount)
language plpgsql
as
$$
declare
begin
    if "Loan_Status" = 'Accepted' THEN
      insert into debit_account("Balance") values (Loan_Amount) where "Account_ID" = "Account_ID"
    else if "Loan_Status" = 'Denied' THEN
      delete from loans where "Loan_Status" = 'Denied'
    end if;
end;
$$;
